...
import { d as gt, f as mt, m as pt, n as logger } from "./logger-CyBffPrB.mjs";
import { t as templateNames } from "./names-eOHfdsDZ.mjs";
import { c as resolve, n as dirname, r as extname } from "./pathe.M-eThtNZ-BfnU2wdd.mjs";
import { r as relativeToProcess, t as loadKit } from "./kit-Bx45zdA5.mjs";
import { r as pascalCase, t as camelCase } from "./dist-yFBLuM4v.mjs";
...
var add_template_default = defineCommand({
	...
	async run(ctx) {
		...
		mt(colors.cyan("Adding template..."));
		...
		gt(`Generated a new ${colors.cyan(templateName)}!`);
	}
});
//#endregion
