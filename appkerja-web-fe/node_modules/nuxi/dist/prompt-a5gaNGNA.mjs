...
var x = class {
	...
	prompt() {
		return new Promise((u$2, F) => {
			...
			}, this.input.pipe(e), this.rl = u.createInterface({
				input: this.input,
				output: e,
				tabSize: 2,
				prompt: "",
				escapeCodeTimeout: 50
			}), u.emitKeypressEvents(this.input, this.rl), this.rl.prompt(), this.opts.initialValue !== void 0 && this._track && this.rl.write(this.opts.initialValue), this.input.on("keypress", this.onKeypress), d$1(this.input, true), this.output.on("resize", this.render), this.render(), this.once("submit", () => {
				this.output.write(srcExports.cursor.show), this.output.off("resize", this.render), d$1(this.input, false), u$2(this.value);
			}), this.once("cancel", () => {
				this.output.write(srcExports.cursor.show), this.output.off("resize", this.render), d$1(this.input, false), u$2(S);
			});
		});
	}
	onKeypress(u, F) {
...
const V = ce(), u$1 = (t, n) => V ? t : n, le = u$1("❯", ">"), L = u$1("■", "x"), W = u$1("▲", "x"), C = u$1("✔", "√"), o = u$1(""), d = u$1(""), k = u$1("●", ">"), P = u$1("○", " "), A = u$1("◻", "[•]"), T = u$1("◼", "[+]"), F = u$1("◻", "[ ]"), w = (t) => {
	switch (t) {
		case "initial":
