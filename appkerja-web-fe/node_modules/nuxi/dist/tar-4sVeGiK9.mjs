...
while (this[be](this[Te]()) && this[b].length);
	...
	[j]() {
		fs$1.open(this[M], `r`, (e, t) => this[$e](e, t));
	}
	[$e](e, t) {
	...
	[rt]() {
		if (!this[P]) {
			...
			fs$1.read(this[k], e, 0, e.length, null, (e, t, n) => this[et](e, t, n));
		}
	}
	[et](e, t, n) {
	...
	[O]() {
		if (this[D] && typeof this[k] == `number`) {
			let e = this[k];
			this[k] = void 0, fs$1.close(e, (e) => e ? this.emit(`error`, e) : this.emit(`close`));
		}
	}
	[Qe](e) {
	...
	[j]() {
		let e = !0;
		try {
			this[$e](null, fs$1.openSync(this[M], `r`)), e = !1;
		} finally {
			e && this[O]();
		}
	}
	[rt]() {
		...
		try {
			if (!this[P]) {
				this[P] = !0;
				do {
					let e = this[Ye](), t = e.length === 0 ? 0 : fs$1.readSync(this[k], e, 0, e.length, null);
	...
	[O]() {
		if (this[D] && typeof this[k] == `number`) {
			let e = this[k];
			this[k] = void 0, fs$1.closeSync(e), this.emit(`close`);
		}
	}
}, pt = class extends l {
	readable = !1;
	...
	[j]() {
		fs$1.open(this[M], this[A], this[Xe], (e, t) => this[$e](e, t));
	}
	[$e](e, t) {
	...
	[st](e) {
		fs$1.write(this[k], e, 0, e.length, this[nt], (e, t) => this[tt](e, t));
	}
	[tt](e, t) {
	...
	[j]() {
		...
		if (this[lt] && this[A] === `r+`) try {
			e = fs$1.openSync(this[M], this[A], this[Xe]);
		} catch (e) {
			if (e?.code === `ENOENT`) return this[A] = `w`, this[j]();
			throw e;
		}
		else e = fs$1.openSync(this[M], this[A], this[Xe]);
		this[$e](null, e);
	}
	[O]() {
		if (this[D] && typeof this[k] == `number`) {
	...
	[st](e) {
		let t = !0;
		try {
			this[tt](null, fs$1.writeSync(this[k], e, 0, e.length, this[nt])), t = !1;
		} finally {
			if (t) try {
				this[O]();
			} catch {}
...
while (this[Dn](this[W].shift()));
	...
	try {
		i = fs.openSync(r, `r`);
		let a = fs.fstatSync(i), o = e.maxReadSize || 16 * 1024 * 1024;
		if (a.size < o) {
			let e = Buffer.allocUnsafe(a.size), r = fs.readSync(i, e, 0, a.size, 0);
			n.end(r === e.byteLength ? e : e.subarray(0, r));
		} else {
			let e = 0, r = Buffer.allocUnsafe(o);
			for (; e < a.size;) {
				let a = fs.readSync(i, r, 0, o, e);
				if (a === 0) break;
	...
	return new Promise((e, n) => {
		r.on(`error`, n), r.on(`end`, e), fs.stat(a, (e, t) => {
			if (e) n(e);
			else {
				let e = new dt(a, {
					readSize: i,
...
}), $n = (e, t, n) => (e &= 4095, n && (e = (e | 384) & -19), t && (e & 256 && (e |= 64), e & 32 && (e |= 8), e & 4 && (e |= 1)), e), { isAbsolute: er, parse: tr } = win32, nr = (e) => {
	let t = ``, n = tr(e);
	for (; er(e) || n.root;) {
	...
	constructor(e, t = {}) {
		...
		this.win32 = !!n.win32 || process.platform === `win32`, this.win32 && (this.path = cr(this.path.replaceAll(/\\/g, `/`)), e = e.replaceAll(/\\/g, `/`)), this.absolute = z(n.absolute || Path.resolve(this.cwd, e)), this.path === `` && (this.path = `./`), r && this.warn(`TAR_ENTRY_INFO`, `stripping ${r} from absolute path`, {
			entry: this,
			path: r + this.path
		});
	...
	[hr](e) {
		...
		this.type = `Link`, this.linkpath = z(Path.relative(this.cwd, e)), this.stat.size = 0, this[gr](), this.end();
	}
	[fr]() {
	...
	sync = !0;
	[vr]() {
		this[yr](fs$1.lstatSync(this.absolute));
	}
	[mr]() {
		this[xr](fs$1.readlinkSync(this.absolute));
	}
	[Sr]() {
		this[Cr](fs$1.openSync(this.absolute, `r`));
	}
	[_r]() {
		let e = !0;
		try {
...
var Fr = class {
	...
	[Kr](e) {
		let t = z(Path.resolve(this.cwd, e.path));
	...
	[Gr](e) {
		let t = z(Path.resolve(this.cwd, e));
		this[X].push(new Ir(e, t)), this[Vr]();
	}
	[qr](e) {
		e.pending = !0, this[Z] += 1, fs$1[this.follow ? `stat` : `lstat`](e.absolute, (t, n) => {
	...
	[Jr](e) {
		e.pending = !0, this[Z] += 1, fs$1.readdir(e.absolute, (t, n) => {
	...
	[qr](e) {
		...
		this[Rr](e, fs$1[t](e.absolute));
	}
	[Jr](e) {
		this[Yr](e, fs$1.readdirSync(e.absolute));
	}
	[Xr](e) {
		let t = e.entry, n = this.zip;
	...
	for (let n of t) n.charAt(0) === `@` ? await Qn({
		file: path.resolve(String(e.cwd), n.slice(1)),
		noResume: !0,
		onReadEntry: (t) => {
			e.add(t);
		}
	...
	t.isDirectory() ? Ci(path.resolve(e, t.name), n, r, (o) => {
		if (o) return a(o);
		xi(path.resolve(e, t.name), n, r, a);
	}) : xi(path.resolve(e, t.name), n, r, a);
}, Ci = (e, n, r, i) => {
	fs.readdir(e, { withFileTypes: !0 }, (t, a) => {
		if (t) {
	...
	t.isDirectory() && Ti(path.resolve(e, t.name), n, r), bi(path.resolve(e, t.name), n, r);
}, Ti = (e, n, r) => {
	let i;
	try {
		i = fs.readdirSync(e, { withFileTypes: !0 });
	} catch (t) {
		let i = t;
	...
	let o = r.umask ?? 18, s = r.mode | 448, c = (s & o) !== 0, l = r.uid, u = r.gid, d = typeof l == `number` && typeof u == `number` && (l !== r.processUid || u !== r.processGid), f = r.preserve, ee = r.unlink, p = z(r.cwd), m = (n, r) => {
		n ? a(n) : r && d ? Ci(r, l, u, (e) => m(e)) : c ? fs.chmod(e, s, a) : a();
	};
	...
	Ai(p, z(path.relative(p, e)).split(`/`), s, ee, p, void 0, m);
}, Ai = (e, n, r, a, o, s, c) => {
	if (n.length === 0) return c(null, s);
	let l = n.shift(), u = z(path.resolve(e + `/` + l));
	fs.mkdir(u, r, ji(u, n, r, a, o, s, c));
}, ji = (e, n, r, i, a, o, s) => (c) => {
	c ? fs.lstat(e, (l, u) => {
		if (l) l.path = l.path && z(l.path), s(l);
		else if (u.isDirectory()) Ai(e, n, r, i, a, o, s);
		else if (i) fs.unlink(e, (c) => {
			if (c) return s(c);
			fs.mkdir(e, r, ji(e, n, r, i, a, o, s));
		});
		else {
	...
	let r = n.umask ?? 18, a = n.mode | 448, o = (a & r) !== 0, s = n.uid, c = n.gid, l = typeof s == `number` && typeof c == `number` && (s !== n.processUid || c !== n.processGid), u = n.preserve, d = n.unlink, f = z(n.cwd), ee = (n) => {
		n && l && Ti(n, s, c), o && fs.chmodSync(e, a);
	};
	if (e === f) return Mi(f), ee();
	if (u) return ee(fs.mkdirSync(e, {
		mode: a,
		recursive: !0
	}) ?? void 0);
	let p = z(path.relative(f, e)).split(`/`), m;
	for (let e = p.shift(), n = f; e && (n += `/` + e); e = p.shift()) {
		n = z(path.resolve(n));
		try {
			fs.mkdirSync(n, a), m ||= n;
		} catch {
			let e = fs.lstatSync(n);
			if (e.isDirectory()) continue;
			if (d) {
				fs.unlinkSync(n), fs.mkdirSync(n, a), m ||= n;
				continue;
	...
	#s = /* @__PURE__ */ new Set();
	reserve(e, t) {
		e = Ri ? [`win32 parallelization disabled`] : e.map((e) => Yn(join(Li(e))));
	...
	if (!fa) return fs.unlink(e, n);
	let r = e + `.DELETE.` + randomBytes(16).toString(`hex`);
	fs.rename(e, r, (e) => {
		if (e) return n(e);
		fs.unlink(r, n);
	});
}, ha = (e) => {
	if (!fa) return fs.unlinkSync(e);
	let n = e + `.DELETE.` + randomBytes(16).toString(`hex`);
	fs.renameSync(e, n), fs.unlinkSync(n);
	...
	[ea](e, t) {
		...
		if (s.includes(`..`) || fa && /^[a-z]:\.\.$/i.test(s[0] ?? ``)) {
			...
			let a = path.posix.dirname(e.path), o = path.posix.normalize(path.posix.join(a, s.join(`/`)));
	...
	[$i](e) {
		...
		if (e.absolute = path.isAbsolute(e.path) ? z(path.resolve(e.path)) : z(path.resolve(this.cwd, e.path)), !this.preservePaths && typeof e.absolute == `string` && e.absolute.indexOf(this.cwd + `/`) !== 0 && e.absolute !== this.cwd) return this.warn(`TAR_ENTRY_ERROR`, `path escaped extraction target`, {
			entry: e,
			path: z(e.path),
	...
	[Ki](e, n) {
		...
		i.on(`error`, (r) => {
			i.fd && fs.close(i.fd, () => {}), i.write = () => !0, this[$](r, e), n();
		});
		let a = 1, o = (r) => {
			if (r) {
				i.fd && fs.close(i.fd, () => {}), this[$](r, e), n();
				return;
			}
			--a === 0 && i.fd !== void 0 && fs.close(i.fd, (t) => {
		...
		i.on(`finish`, () => {
			...
			if (typeof r == `number` && e.mtime && !this.noMtime) {
				...
				fs.futimes(r, i, s, (e) => e ? fs.utimes(n, i, s, (t) => o(t && e)) : o());
			}
			if (typeof r == `number` && this[ca](e)) {
				a++;
				let i = this[la](e), s = this[ua](e);
				typeof i == `number` && typeof s == `number` && fs.fchown(r, i, s, (e) => e ? fs.chown(n, i, s, (t) => o(t && e)) : o());
			}
			o();
		});
	...
	[qi](e, n) {
		...
		this[ta](String(e.absolute), r, (r) => {
			...
			e.mtime && !this.noMtime && (i++, fs.utimes(String(e.absolute), e.atime || /* @__PURE__ */ new Date(), e.mtime, a)), this[ca](e) && (i++, fs.chown(String(e.absolute), Number(this[la](e)), Number(this[ua](e)), a)), a();
		});
	}
	[Qi](e) {
	...
	[Yi](e, t) {
		let n = z(path.relative(this.cwd, path.resolve(path.dirname(String(e.absolute)), String(e.linkpath)))).split(`/`);
		this[Zi](e, this.cwd, n, () => this[Ji](e, String(e.linkpath), `symlink`, t), (n) => {
			this[$](n, e), t();
		});
	}
	[Xi](e, t) {
		let n = z(path.resolve(this.cwd, String(e.linkpath))), r = z(String(e.linkpath)).split(`/`);
	...
	[Zi](e, n, r, a, o) {
		...
		let c = path.resolve(n, s);
		fs.lstat(c, (t, n) => {
			if (t) return a();
			if (n?.isSymbolicLink()) return o(new Di(c, path.resolve(c, r.join(`/`))));
			this[Zi](e, c, r, a, o);
		});
	}
	[ra]() {
	...
	[Wi](e, n) {
		let r = (e) => {
			...
			if (e.absolute !== this.cwd) {
				let t = z(path.dirname(String(e.absolute)));
			...
			fs.lstat(String(e.absolute), (n, i) => {
				...
				if (i.isDirectory()) {
					if (e.type === `Directory`) {
						...
						return n ? fs.chmod(String(e.absolute), Number(e.mode), a) : a();
					}
					if (e.absolute !== this.cwd) return fs.rmdir(String(e.absolute), (t) => this[Q](t ?? null, e, r));
				}
	...
	[Ui](e) {
		...
		let [n, r] = va(() => fs.lstatSync(String(e.absolute)));
		...
		if (r.isDirectory()) {
			...
			let [n] = va(() => fs.rmdirSync(String(e.absolute)));
			this[Q](n, e);
		}
	...
	[Ki](e, n) {
		...
		try {
			a = fs.openSync(String(e.absolute), yi(e.size), r);
		} catch (e) {
			return i(e);
		}
		...
		o !== e && (o.on(`error`, (t) => this[$](t, e)), e.pipe(o)), o.on(`data`, (e) => {
			...
			if (e.mtime && !this.noMtime) {
				...
				try {
					fs.futimesSync(a, r, i);
				} catch (a) {
					try {
						fs.utimesSync(String(e.absolute), r, i);
					} catch {
						n = a;
					}
				}
			...
			if (this[ca](e)) {
				...
				try {
					fs.fchownSync(a, Number(r), Number(i));
				} catch (a) {
					try {
						fs.chownSync(String(e.absolute), Number(r), Number(i));
					} catch {
						n ||= a;
					}
				}
	...
	[qi](e, n) {
		...
		if (this[ca](e)) try {
			fs.chownSync(String(e.absolute), Number(this[la](e)), Number(this[ua](e)));
		} catch {}
		n(), e.resume();
	}
	[ta](e, t) {
	...
	[Zi](e, n, r, a, o) {
		...
		for (let e of r) {
			s = path.resolve(s, e);
			let [c, l] = va(() => fs.lstatSync(s));
			if (c) return a();
			if (l.isSymbolicLink()) return o(new Di(s, path.resolve(n, r.join(`/`))));
		}
		a();
	}
	[Ji](e, n, r, i) {
		let a = `${r}Sync`;
		try {
			fs[a](n, String(e.absolute)), i(), e.resume();
		} catch (t) {
			return this[$](t, e);
		}
	}
}, ba = Ct((e) => {
	let n = new ya(e), r = e.file, i = fs.statSync(r);
	new ft(r, {
	...
	return new Promise((e, n) => {
		r.on(`error`, n), r.on(`close`, e), fs.stat(a, (e, t) => {
			if (e) n(e);
			else {
				let e = new dt(a, {
					readSize: i,
	...
	try {
		try {
			a = fs.openSync(e.file, `r+`);
		} catch (n) {
			if (n?.code === `ENOENT`) a = fs.openSync(e.file, `w+`);
			else throw n;
		}
		let s = fs.fstatSync(a), c = Buffer.alloc(512);
		t: for (o = 0; o < s.size; o += 512) {
			for (let e = 0, n = 0; e < 512; e += n) {
				if (n = fs.readSync(a, c, e, c.length - e, o + e), o === 0 && c[0] === 31 && c[1] === 139) throw Error(`cannot append to compressed archives`);
				if (!n) break t;
			}
			let n = new I(c);
	...
	let r = new ni(e), i = (n, r, i) => {
		let a = (e, r) => {
			e ? fs.close(n, (t) => i(e)) : i(null, r);
		}, o = 0;
		if (r === 0) return a(null, 0);
		let s = 0, c = Buffer.alloc(512), l = (i, u) => {
			if (i || u === void 0) return a(i);
			if (s += u, s < 512 && u) return fs.read(n, c, s, c.length - s, o + s, l);
			...
			e.mtimeCache && d.mtime && e.mtimeCache.set(String(d.path), d.mtime), s = 0, fs.read(n, c, 0, 512, o, l);
		};
		fs.read(n, c, 0, 512, o, l);
	};
