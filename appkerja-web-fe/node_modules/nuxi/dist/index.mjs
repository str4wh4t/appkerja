...
import { n as name, r as version, t as description } from "./package-DpeK5wiG.mjs";
import { t as cwdArgs } from "./_shared-D6pJgr6t.mjs";
import { t as runCommand } from "./run-CwixkrKi.mjs";
import { t as consola } from "./dist-BP14MYpv.mjs";
import { n as logger, t as debug } from "./logger-CyBffPrB.mjs";
...
const commands = {
	"add": () => import("./add-BB-mMFtJ.mjs").then(_rDefault),
	"add-template": () => import("./add-template-DRcJpJRV.mjs").then(_rDefault),
	"analyze": () => import("./analyze-C82BUXyJ.mjs").then(_rDefault),
	"build": () => import("./build-LCLK3Emi.mjs").then(_rDefault),
	"cleanup": () => import("./cleanup-DKSrKgwp.mjs").then(_rDefault),
	"_dev": () => import("./dev-child-ezkhyRu2.mjs").then(_rDefault),
	"dev": () => import("./dev-CTY6FvCZ.mjs").then(_rDefault),
	"devtools": () => import("./devtools-DG45LMli.mjs").then(_rDefault),
	"generate": () => import("./generate-BrZ8iZwl.mjs").then(_rDefault),
	"info": () => import("./info-uKpLzviL.mjs").then(_rDefault),
	"init": () => import("./init-Db2YNk-O.mjs").then(_rDefault),
	"module": () => import("./module-CT3CFNNH.mjs").then(_rDefault),
	"prepare": () => import("./prepare-BbARTNLY.mjs").then((n) => n.n).then(_rDefault),
	"preview": () => import("./preview-CU-qcMVC.mjs").then(_rDefault),
	"start": () => import("./preview-CU-qcMVC.mjs").then(_rDefault),
	"test": () => import("./test-mebApG6p.mjs").then(_rDefault),
	"typecheck": () => import("./typecheck-CJNGCfY9.mjs").then(_rDefault),
	"upgrade": () => import("./upgrade-Cm8_CzJI.mjs").then(_rDefault)
};
//#endregion
...
async function checkEngines() {
	const satisfies = await import("./satisfies-DdI14fmA.mjs").then((n) => /* @__PURE__ */ __toESM(n.t(), 1)).then((r) => r.default || r);
...
const main = defineCommand({
	...
	async setup(ctx) {
		...
		if (command === "add" && ctx.rawArgs[1] && templateNames.includes(ctx.rawArgs[1])) {
			...
			await runCommand(await import("./add-template-DRcJpJRV.mjs").then((m) => m.default || m), [...ctx.rawArgs.slice(1)]).catch((err) => {
		...
		if (ctx.args.command && !(ctx.args.command in commands)) {
			...
			try {
				const { x } = await import("./main-KHdCdNiY.mjs").then((n) => n.n);
...
async function runMain() {
	if (process.argv[2] === "complete") {
		const { initCompletions } = await import("./completions-5YT8adyZ.mjs");
