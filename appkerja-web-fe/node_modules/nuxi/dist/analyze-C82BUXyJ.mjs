...
import { d as gt, f as mt, g as wt, n as logger, o as Gt } from "./logger-CyBffPrB.mjs";
import { t as defu } from "./defu-C23GdbdT.mjs";
import { t as overrideEnv } from "./env-yxpHlEEY.mjs";
import { a as join, c as resolve } from "./pathe.M-eThtNZ-BfnU2wdd.mjs";
import { r as relativeToProcess, t as loadKit } from "./kit-Bx45zdA5.mjs";
import { i as FastURL, n as serve, t as NodeResponse } from "./node-2KsOo3qw.mjs";
import { n as clearDir } from "./fs-BluFAvtr.mjs";
...
var analyze_default = defineCommand({
	...
	async run(ctx) {
		...
		mt(colors.cyan("Analyzing bundle size..."));
		...
		} else gt("✨ Analysis build complete!");
	}
});
//#endregion
