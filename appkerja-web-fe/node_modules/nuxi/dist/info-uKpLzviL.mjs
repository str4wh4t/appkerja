...
import { a as k, s as x, t as A } from "./dist-BkNIIgFa.mjs";
import { r as version } from "./package-DpeK5wiG.mjs";
import { a as legacyRootDirArgs, t as cwdArgs } from "./_shared-D6pJgr6t.mjs";
import { l as at, n as logger } from "./logger-CyBffPrB.mjs";
import { c as resolve } from "./pathe.M-eThtNZ-BfnU2wdd.mjs";
import { n as tryResolveNuxt } from "./kit-Bx45zdA5.mjs";
import { r as readPackageJSON } from "./dist-BPzTdxaO.mjs";
import { t as getBuilder } from "./banner-Bf-4_Uw9.mjs";
import { writeText } from "./dist-CXuRnu3A.mjs";
import { r as detectPackageManager } from "./dist-BPIY2x9n.mjs";
...
var info_default = defineCommand({
	...
	async run(ctx) {
		...
		const infoObj = {
			...
			...k ? { "Bun version": Bun?.version } : A ? { "Deno version": Deno?.version.deno } : { "Node.js version": process.version },
...
async function getNuxtConfig(rootDir) {
	try {
		const { createJiti } = await import("./jiti-DIDkIovA.mjs").then((n) => n.t);
