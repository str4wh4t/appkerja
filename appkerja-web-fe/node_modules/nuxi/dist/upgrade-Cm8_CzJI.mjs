...
import { a as legacyRootDirArgs, o as logLevelArgs, t as cwdArgs } from "./_shared-D6pJgr6t.mjs";
import { _ as q, a as Et, c as _t, d as gt, f as mt, g as wt, m as pt, n as logger, u as fe } from "./logger-CyBffPrB.mjs";
import { c as resolve } from "./pathe.M-eThtNZ-BfnU2wdd.mjs";
import { r as relativeToProcess, t as loadKit } from "./kit-Bx45zdA5.mjs";
import { n as findWorkspaceDir, r as readPackageJSON } from "./dist-BPzTdxaO.mjs";
import { t as getNuxtVersion } from "./versions-C03Rdwvz.mjs";
import { r as nuxtVersionToGitIdentifier, t as cleanupNuxtDirs } from "./nuxt-oQsmuFkJ.mjs";
import { n as dedupeDependencies, r as detectPackageManager, t as addDependency } from "./dist-BPIY2x9n.mjs";
import { t as getPackageManagerVersion } from "./packageManagers-BdTDSXBz.mjs";
...
var upgrade_default = defineCommand({
	...
	async run(ctx) {
		...
		if (upgradedVersion === currentVersion) gt(`You were already using the latest version of Nuxt (${colors.green(currentVersion)})`);
			...
			if (commitA && commitB) wt(`https://github.com/nuxt/nuxt/compare/${commitA}...${commitB}`, "Changelog");
			gt("✨ Upgrade complete!");
		}
	}
});
