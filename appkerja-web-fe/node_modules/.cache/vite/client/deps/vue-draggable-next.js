...
var VueDraggableNext = defineComponent({
  ...
  setup(props, { emit, slots, attrs }) {
    ...
    function getChildrenNodes() {
      var _a;
      return ((_a = instance == null ? void 0 : instance.proxy) == null ? void 0 : _a.$el.children) || [];
    }
    async function computeIndexesFn() {
      var _a;
      await nextTick();
      visibleIndexes.value = computeIndexes(getChildrenNodes(), ((_a = instance == null ? void 0 : instance.proxy) == null ? void 0 : _a.$el.children) || [], transitionMode.value, footerOffset.value);
    }
    ...
    function getComponent() {
      ...
      return ((_b = (_a = sl[0]) == null ? void 0 : _a.component) == null ? void 0 : _b.proxy) || null;
    }
    ...
    function onDragRemove(evt) {
      var _a;
      insertNodeAt((_a = instance == null ? void 0 : instance.proxy) == null ? void 0 : _a.$el, evt.item, evt.oldIndex);
    ...
    function onDragUpdate(evt) {
      ...
      const oldIndex2 = (_a = context.value) == null ? void 0 : _a.index;
      const newIndex2 = getVmIndex(evt.newIndex);
      updatePosition(oldIndex2, newIndex2);
      emitChanges({
        moved: { element: (_b = context.value) == null ? void 0 : _b.element, oldIndex: oldIndex2, newIndex: newIndex2 }
      });
    }
    ...
    const mounted = () => {
      ...
      const targetDomElement = ((_a = instance == null ? void 0 : instance.proxy) == null ? void 0 : _a.$el.nodeType) === 1 ? instance.proxy.$el : ((_b = instance == null ? void 0 : instance.proxy) == null ? void 0 : _b.$el.parentElement) || null;
      if (targetDomElement) {
        sortableInstance.value = new Sortable(targetDomElement, options);
        targetDomElement.__draggable_component__ = instance == null ? void 0 : instance.proxy;
        computeIndexesFn();
      }
    };
