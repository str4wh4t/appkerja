            ...
            <v-row class="justify-center">
                <v-col cols="12" md="9" class="text-center">
                    <h1 class="text-52 text-grey200 bannerTitle " data-aos="fade-up" data-aos-delay="400"
                        ...
                        Revolutionize your development with Powerful NuxtJs dashboard</h1>
                    ...
                    <div class="mt-6 d-sm-flex gap-3 justify-center" data-aos="fade-up" data-aos-delay="800"
                        ...
                        <v-btn to="" v-scroll-to="'#demos'" color="primary" rounded="pill"
                            ...
                            Preview</v-btn>
                        <v-btn target="_blank" rounded="pill" variant="outlined" href="https://wrappixel.github.io/premium-documentation-wp/nuxt/spike/index.html" color="primary" size="large"
