  ...
  <div class="text-center">
    ...
    <v-dialog v-model="dialog" max-width="800">
      <v-card class="pa-6">
        ...
        <v-card-actions>
          <v-btn color="secondary" text @click="dialog = false" variant="tonal" class="px-4 rounded-pill"> Close </v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    ...
    <v-dialog v-model="dialog2" max-width="700">
      <v-card class="pa-6">
        ...
        <v-card-actions>
          <v-btn color="secondary" text @click="dialog2 = false" variant="tonal" class="px-4 rounded-pill"> Close </v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    ...
    <v-dialog v-model="dialog3" max-width="600">
      <v-card class="pa-6">
        ...
        <v-card-actions>
          <v-btn color="secondary" text @click="dialog3 = false" variant="tonal" class="px-4 rounded-pill"> Close </v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </div>
